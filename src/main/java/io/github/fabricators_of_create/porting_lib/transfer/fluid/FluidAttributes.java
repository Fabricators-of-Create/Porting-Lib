...
public class FluidAttributes {
	...
	public int getLuminosity(BlockAndTintGetter world, BlockPos pos) {
		return getLuminosity();
	}

	public int getDensity(BlockAndTintGetter world, BlockPos pos) {
		return getDensity();
	}

	public int getTemperature(BlockAndTintGetter world, BlockPos pos) {
		return getTemperature();
	}

	public int getViscosity(BlockAndTintGetter world, BlockPos pos) {
		return getViscosity();
	}

	public boolean isGaseous(BlockAndTintGetter world, BlockPos pos) {
		return isGaseous();
	}

	public Rarity getRarity(BlockAndTintGetter world, BlockPos pos) {
		return getRarity();
	}
	...
	public ResourceLocation getStillTexture(BlockAndTintGetter world, BlockPos pos) {
		return getStillTexture();
	}

	public ResourceLocation getFlowingTexture(BlockAndTintGetter world, BlockPos pos) {
		return getFlowingTexture();
	}

	public SoundEvent getFillSound(BlockAndTintGetter world, BlockPos pos) {
		return getFillSound();
	}

	public SoundEvent getEmptySound(BlockAndTintGetter world, BlockPos pos) {
		return getEmptySound();
	}
