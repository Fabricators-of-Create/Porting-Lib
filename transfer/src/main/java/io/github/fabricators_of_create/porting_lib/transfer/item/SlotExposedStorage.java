...
public interface SlotExposedStorage extends Storage<ItemVariant> {
	...
	default long insertSlot(int slot, ItemVariant resource, long maxAmount, TransactionContext transaction) {
		PortingLib.LOGGER.warn("Tried to insert to a slotted storage without a implementation! Implementations will be forced to implement this in 1.19.3");
	...
	default long extractSlot(int slot, ItemVariant resource, long maxAmount, TransactionContext transaction) {
		PortingLib.LOGGER.warn("Tried to extract from a slotted storage without a implementation! Implementations will be forced to implement this in 1.19.3");
