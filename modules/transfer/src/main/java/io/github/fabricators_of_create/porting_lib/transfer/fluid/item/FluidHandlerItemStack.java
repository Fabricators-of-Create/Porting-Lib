...
//public class FluidHandlerItemStack implements Storage<FluidVariant> { TODO: PORT
...
//	 */
//	public FluidHandlerItemStack(Supplier<DataComponentType<SimpleFluidContent>> componentType, @NotNull ContainerItemContext container, long capacity) {
...
//		return container.getItemVariant().getComponents().get(componentType, SimpleFluidContent.EMPTY).copy()
//	}
//
...
//
//		public SwapEmpty(Supplier<DataComponentType<SimpleFluidContent>> componentType, ContainerItemContext container, ItemStack emptyContainer, int capacity) {
