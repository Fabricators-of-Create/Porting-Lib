...
public class BlockGeometryBakingContext implements IGeometryBakingContext {
	...
	public IUnbakedGeometry<?> getCustomGeometry() {
		return owner.parent != null && customGeometry == null ? owner.parent.port_lib$getCustomData().getCustomGeometry() : customGeometry;
	}
	...
	public boolean isComponentVisible(String part, boolean fallback) {
		return owner.parent != null && !visibilityData.hasCustomVisibility(part) ? owner.parent.port_lib$getCustomData().isComponentVisible(part, fallback) : visibilityData.isVisible(part, fallback);
	}
	...
	public Transformation getRootTransform() {
		...
		return owner.parent != null ? owner.parent.port_lib$getCustomData().getRootTransform() : Transformation.identity();
	}
	...
	public ResourceLocation getRenderTypeHint() {
		...
		return owner.parent != null ? owner.parent.port_lib$getCustomData().getRenderTypeHint() : null;
	}
