...
public class BlockGeometryBakingContext implements IGeometryBakingContext {
	...
	public IUnbakedGeometry<?> getCustomGeometry() {
		return owner.parent != null && customGeometry == null ? owner.parent.getPortingLibCustomData().getCustomGeometry() : customGeometry;
	}
	...
	public boolean isComponentVisible(String part, boolean fallback) {
		return owner.parent != null && !visibilityData.hasCustomVisibility(part) ?
				owner.parent.getPortingLibCustomData().isComponentVisible(part, fallback) :
	...
	public Transformation getRootTransform() {
		...
		return owner.parent != null ? owner.parent.getPortingLibCustomData().getRootTransform() : Transformation.identity();
	}
	...
	public ResourceLocation getRenderTypeHint() {
		...
		return owner.parent != null ? owner.parent.getPortingLibCustomData().getRenderTypeHint() : null;
	}
