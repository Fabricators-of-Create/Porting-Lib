...
import io.github.fabricators_of_create.porting_lib.resources.injections.HolderInjection;
 ...
 * Data maps are registered to {@link PortingLibDataMaps#registerDataMap(DataMapType)}. <p>
 ...
 *
 * <p>
 * You can access a data map using {@link RegistryInjection#getDataMap(DataMapType)} and {@link IWithData#getData(DataMapType)}. <br>
 * You can usually go through {@linkplain HolderInjection#getData(DataMapType)} Holder} implementations in order to get the data of an object directly.
 *
