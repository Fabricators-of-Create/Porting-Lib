...
public interface RenderTargetExtension {
	 ...
	 */
	default void port_lib$enableStencil() {
		throw new RuntimeException("this should be overridden via mixin. what?");
	}

	/** @see RenderTargetExtension#port_lib$enableStencil() */
	default void port_lib$disableStencil() {
		throw new RuntimeException("this should be overridden via mixin. what?");
	}
	 ...
	 */
	default boolean port_lib$isStencilEnabled() {
		return false;
	}
}
