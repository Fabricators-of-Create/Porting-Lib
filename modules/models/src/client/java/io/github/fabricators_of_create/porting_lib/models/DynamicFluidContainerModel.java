...
public class DynamicFluidContainerModel implements IUnbakedGeometry<DynamicFluidContainerModel> {
	...
	public static RenderTypeGroup getLayerRenderTypes(boolean unlit) {
		return new RenderTypeGroup(RenderType.translucent(), unlit ? PortingLibRenderTypes.ITEM_UNSORTED_UNLIT_TRANSLUCENT.get() : PortingLibRenderTypes.ITEM_UNSORTED_TRANSLUCENT.get());
	}
	...
	public BakedModel bake(IGeometryBakingContext context, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides) {
		...
		if (flipGas && fluid != Fluids.EMPTY && FluidVariantAttributes.isLighterThanAir(fluid)) {
