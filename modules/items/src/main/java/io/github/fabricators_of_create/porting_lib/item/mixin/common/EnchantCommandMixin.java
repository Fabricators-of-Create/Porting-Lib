...
public abstract class EnchantCommandMixin {
	...
	private static boolean port_lib$checkItemSupportsEnchantment(Enchantment instance, ItemStack stack, Operation<Boolean> original, @Local(argsOnly = true) Holder<Enchantment> holder) {
