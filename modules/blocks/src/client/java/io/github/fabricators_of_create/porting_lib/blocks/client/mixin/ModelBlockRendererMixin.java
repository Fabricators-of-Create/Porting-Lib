...
public class ModelBlockRendererMixin {
	...
	private int port_lib$customLight(BlockState instance, Operation<Integer> original, BlockAndTintGetter level, List<BlockModelPart> parts, BlockState state, BlockPos pos) {
