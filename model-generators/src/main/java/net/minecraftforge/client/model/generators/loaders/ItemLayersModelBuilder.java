...
public class ItemLayersModelBuilder<T extends ModelBuilder<T>> extends CustomLoaderBuilder<T> {
	...
	public JsonObject toJson(JsonObject json) {
		...
		json.add("render_types", renderTypes); // todo: this is left only for custom model loaders that support it, vanilla models currently don't support this format yet
