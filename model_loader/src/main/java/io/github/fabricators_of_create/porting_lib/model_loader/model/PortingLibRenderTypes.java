...
import io.github.fabricators_of_create.porting_lib.client_events.event.client.RegisterShadersCallback.ShaderRegistry;
import io.github.fabricators_of_create.porting_lib.mixin.accessors.client.accessor.RenderStateShardAccessor;
...
public enum PortingLibRenderTypes {
	...
	public static class Internal extends RenderType {
		...
		public static void initEntityTranslucentUnlitShader(ResourceProvider resourceManager, ShaderRegistry registry) throws IOException {
