	...
	public JsonObject toJson() {
		...
		if (!transforms.isEmpty()) {
			...
			for (Entry<TransformType, ItemTransform> e : transforms.entrySet()) {
				...
				display.add(e.getKey().name().toLowerCase(Locale.ROOT), transform);
			}
	...
	public class ElementBuilder {
		...
		public class FaceBuilder {
			...
			BlockElementFace build() {
				...
				BlockElementFace face = new BlockElementFace(cullface, tintindex, texture, new BlockFaceUV(uvs, rotation.rotation)/*, hasAmbientOcclusion*/);
	...
	public class TransformsBuilder {
		...
		public class TransformVecBuilder {
			...
			ItemTransform build() {
				...
				((ItemTransformExtensions)transform).setRightRotation(rightRotation);
				return transform;
			}
