...
public final class TransformationHelper
{
	...
	public static class Deserializer implements JsonDeserializer<Transformation>
	{
		...
		public Transformation deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
		{
			...
			Vector3f origin = BlockModelBuilder.RootTransformBuilder.TransformOrigin.OPPOSING_CORNER.getVector(); // TODO: Changing this to ORIGIN_CENTER breaks models, function content needs changing too -C
			...
			if (!BlockModelBuilder.RootTransformBuilder.TransformOrigin.CENTER.getVector().equals(origin))
			{
