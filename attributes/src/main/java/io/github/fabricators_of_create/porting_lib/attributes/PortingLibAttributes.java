...
public class PortingLibAttributes implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(BuiltInRegistries.ATTRIBUTE, PortingConstants.id("block_reach"), BLOCK_REACH);
		Registry.register(BuiltInRegistries.ATTRIBUTE, PortingConstants.id("entity_reach"), ENTITY_REACH);
	}
}
