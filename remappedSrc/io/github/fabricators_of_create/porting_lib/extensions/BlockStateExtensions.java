...
public interface BlockStateExtensions {
	 ...
	 */
	@Nullable
	default BlockState getToolModifiedState(ItemUsageContext context, ToolAction toolAction, boolean simulate) {
	 ...
	 */
	@Nullable
	default BlockState getToolModifiedState(World world, BlockPos pos, PlayerEntity player, ItemStack stack, ToolAction toolAction) {
	 ...
	 */
	default boolean canSustainPlant(BlockView level, BlockPos pos, Direction facing, IPlantable plantable) {
	 ...
	 * {@link net.minecraft.block.Block#isSideInvisible(BlockState, BlockState, Direction)}
	 ...
	 */
	default boolean hidesNeighborFace(BlockView level, BlockPos pos, BlockState neighborState, Direction dir) {
