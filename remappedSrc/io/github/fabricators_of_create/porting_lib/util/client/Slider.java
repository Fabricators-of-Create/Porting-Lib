...
public class Slider extends ExtendedButton {
	 ...
	 */
	@Override
	protected void renderBackground(MatrixStack poseStack, MinecraftClient minecraft, int par2, int par3) {
		if (this.visible) {
			if (this.dragging) {
			...
			GuiUtils.drawContinuousTexturedBox(poseStack, WIDGETS_TEXTURE, this.x + (int)(this.sliderValue * (float)(this.width - 8)), this.y, 0, 66, 8, this.height, 200, 20, 2, 3, 2, 2, this.getZOffset());
		}
	}
