...
public class FluidTextUtil {
	...
	public static class Format extends SinglePreparationResourceReloader<Unit> implements IdentifiableResourceReloadListener {
		...
		@Override
		protected Unit prepare(ResourceManager resourceManager, Profiler profiler) {
			return Unit.INSTANCE;
		}

		@Override
		protected void apply(Unit object, ResourceManager resourceManager, Profiler profiler) {
			update();
		}
