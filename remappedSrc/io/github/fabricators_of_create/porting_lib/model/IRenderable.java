...
public interface IRenderable<T> {
	/**
	 * Draws the renderable by adding the geometry to the provided {@link VertexConsumerProvider}
	 ...
	 * @param lightmapCoord the lightmap coordinates representing the current lighting conditions. See {@link net.minecraft.client.render.LightmapTextureManager}
	 * @param overlayCoord the overlay coordinates representing the current overlay status. See {@link net.minecraft.client.render.OverlayTexture}
	 ...
	 */
	void render(MatrixStack poseStack, VertexConsumerProvider bufferSource, Function<Identifier, RenderLayer> renderTypeFunction, int lightmapCoord, int overlayCoord, float partialTicks, T renderValues);
