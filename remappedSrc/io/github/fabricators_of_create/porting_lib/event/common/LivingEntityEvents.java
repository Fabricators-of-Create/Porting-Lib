...
public class LivingEntityEvents {
	...
	public interface CheckSpawn {
		boolean onCheckSpawn(MobEntity entity, WorldAccess world, double x, double y, double z, @Nullable MobSpawnerLogic spawner, SpawnReason spawnReason);
	}
	...
	public interface ExperienceDropNew {
		int onLivingEntityExperienceDrop(int i, PlayerEntity attackingPlayer, LivingEntity entity);
	}
	...
	public interface ChangeTarget {
		...
		final class ChangeTargetEvent extends EntityEvent {
			...
			public enum LivingTargetType implements ILivingTargetType {
				/**
				 * This target type indicates that the target has been set by calling {@link MobEntity#setTarget(LivingEntity)}.
				 */
				MOB_TARGET,
				/**
				 * This target type indicates that the target has been set by the {@link UpdateAttackTargetTask} behavior.
				 */
				BEHAVIOR_TARGET;
			}
		}
