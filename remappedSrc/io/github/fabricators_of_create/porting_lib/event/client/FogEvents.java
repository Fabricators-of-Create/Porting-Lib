...
public class FogEvents {
	...
	public interface RenderFog {
		void onFogRender(BackgroundRenderer.FogType type, Camera info, float partial, float distance);
	}

	@FunctionalInterface
	public interface ActualRenderFog {
		boolean onFogRender(BackgroundRenderer.FogType type, Camera info, FogData fogData);
	}
