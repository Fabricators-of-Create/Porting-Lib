...
public class ToolActions {
	...
	/**
	 * Passed onto {@link BlockExtensions#getToolModifiedState} when an axe wants to strip a log
	 */
	public static final ToolAction AXE_STRIP = ToolAction.get("axe_strip");

	/**
	 * Passed onto {@link BlockExtensions#getToolModifiedState} when an axe wants to scrape oxidization off copper
	 */
	public static final ToolAction AXE_SCRAPE = ToolAction.get("axe_scrape");

	/**
	 * Passed onto {@link BlockExtensions#getToolModifiedState} when an axe wants to remove wax out of copper
	 */
	public static final ToolAction AXE_WAX_OFF = ToolAction.get("axe_wax_off");

	/**
	 * Passed onto {@link BlockExtensions#getToolModifiedState} when a shovel wants to turn dirt into path
	 */
	...
	/**
	 *  Passed onto {@link BlockExtensions#getToolModifiedState} when a hoe wants to turn dirt into soil
	 */
