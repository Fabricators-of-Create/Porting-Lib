...
public abstract class ShaderInstanceMixin {
	...
	private String port_lib$fixId(String path) {
		if (!path.contains(":")) {
			return path;
		}
	...
	private static String port_lib$fixPath(String path, ResourceProvider resourceProvider, Program.Type programType, String name) {
		if (!name.contains(":")) {
			return path;
		}
		ResourceLocation split = new ResourceLocation(name);
