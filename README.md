...
| `entity_data_serializers` | Adds a API for safely registering entity data serializers.                                     |
...
| `milk`                    | A small library adds milk as an actual fluid                                                   |
...
| `resources`               | NeoForge's conditions and data maps system, with useful resource events                        |
| `tags`                    | Forge tags                                                                                     |
